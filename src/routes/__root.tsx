  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-[28rem] text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo deu errado. Você pode atualizar ou voltar ao início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient; user: AppUser | null }>()({
  beforeLoad: async () => ({ user: await getCurrentUser() }),
  head: () => ({
    meta: [
      { charSet: "utf-8" },
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      { title: "Âncora Access — Suíte de gestão" },
      {
        name: "description",
        content:
          "Suíte Âncora Access para controle de acesso hoteleiro: equipamentos, monitoramento e presença no local.",
      },
